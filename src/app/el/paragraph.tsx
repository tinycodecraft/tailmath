...
const ElCenterGlowSvg = styled('div')(({ theme }) => ({
  ...
  '&::before': {
    ...
    background: `${
      theme.palette.mode == 'light'
        ? theme.palette.sunGlow.secondaryGlow
        : theme.palette.dimGlow.secondaryGlow
    }`,
    //width: '480px',
    height: '360px',
    // marginLeft: '-400px',
  ...
  '&::after': {
    background: `${
      theme.palette.mode == 'light'
        ? theme.palette.sunGlow.primaryGlow
        : theme.palette.dimGlow.primaryGlow
    }`,
    zIndex: -1,
...
const ElShadowSvg = styled(Typography, {
  ...
  '&::after': {
    ...
    background: `linear-gradient(
      ...
      ${
        theme.palette.mode == 'light'
          ? theme.palette.sunTile.startColor
          : theme.palette.dimTile.startColor
      },
      ${
        theme.palette.mode == 'light'
          ? theme.palette.sunTile.endColor
          : theme.palette.dimTile.endColor
      }
    )`,
...
const Elbody = styled('body')`
  ...
  color: ${({ theme }) =>
    theme.palette.mode == 'light'
      ? theme.palette.sunShade.frontColor
      : theme.palette.dimShade.frontColor};
  background: linear-gradient(
      to bottom,
      transparent,
      ${({ theme }) =>
        theme.palette.mode == 'light'
          ? theme.palette.sunShade.bgEndColor
          : theme.palette.dimShade.bgEndColor}
    )
    ${({ theme }) =>
      theme.palette.mode == 'light'
        ? theme.palette.sunShade.bgStartColor
        : theme.palette.dimShade.bgStartColor};
`
